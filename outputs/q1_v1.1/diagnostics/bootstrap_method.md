...
Under the fixed Benchmark set, source structure and model capability applicability, Kimi K3's empirical Top-3 frequency in 2000 Bootstrap replicates is 0.417.
