...
\begin{subfigure}{0.32\textwidth}
\centering
\includegraphics[width=\linewidth]{q3_icer_Research.pdf}
\caption{Research}
\end{subfigure}
\begin{subfigure}{0.32\textwidth}
\centering
\includegraphics[width=\linewidth]{q3_icer_General.pdf}
\caption{General}
\end{subfigure}
\begin{subfigure}{0.32\textwidth}
\centering
\includegraphics[width=\linewidth]{q3_icer_Coding.pdf}
\caption{Coding}
\end{subfigure}
\caption{三类场景 Pareto 前沿相邻升级的增量成本效益}
\label{fig:icer}
\end{figure}
